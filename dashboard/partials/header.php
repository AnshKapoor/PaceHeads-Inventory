...
$read_access_display = $_SESSION['has_read_access'] ? 'Yes' : 'No';
$edit_access_display = $_SESSION['has_edit_access'] ? 'Yes' : 'No';
$special_edit_access_display = $_SESSION['has_special_edit_access'] ? 'Yes' : 'No';
